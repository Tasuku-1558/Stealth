...
const int	 SelectionUi::STAGE_NUMBER			  = 3;							//ステージ数
...
const VECTOR SelectionUi::STAGE2_POSITION		  = { 1700.0f, 100.0f, -300.0f };	//ステージ2モデルの位置
const VECTOR SelectionUi::STAGE2_SIZE			  = { 8.0f, 8.0f, 8.0f };			//ステージ2モデルの倍率
const VECTOR SelectionUi::STAGE2_ROTATE = { 90.0f * DX_PI_F / 180.0f, 180.0f * DX_PI_F / 180.0f, 90.0f * DX_PI_F / 180.0f }; //ステージ2モデルの回転値

const VECTOR SelectionUi::STAGE3_POSITION		  = { 1200.0f, 750.0f, -150.0f };	//ステージ3モデルの位置
